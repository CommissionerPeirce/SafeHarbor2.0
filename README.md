...
Brookwood Comment: The exit report framework is directionally correct on a substantive basis from my perspective, but passing the burden for analysis to outside counsel alone absent additional measures creates two potential problems that would frustrate the aims of this bill. First, it is likely that top tier biglaw and boutique firms would be extraordinarily cautious and charge significant premiums for such a report if 10b5 liability for the firm would arise in any situation other than wilful misconduct on the firm's behalf (and not for omissions). This would potentially limit the accessability of high quality counsel to all but the most well funded projects. The end result would potentially further entrench vested and moneyed interests who have access to these service providers, particularly given the fact that currently, it is quite difficult to identify competent legal providers with excess bandwidth.

Relatedly and as a corollary to the point above, it would seem to me that this would also incentivize a cottage industry of legal "crypto ambulance chasers" who are willing to produce subpar reports to land clients. This gamesmanship has been seen in other areas of the law, and indeed, in crypto during the 2017-2018 mania, reports of unqualified firms producing "securities analysis" became a meme amongst legal commentators. This problem is further compounded by the fact that many projects would likely SEEK OUT subpar opinions so long as they passed certification. This likely will result in "race to the bottom" conditions that won't serve the public interest and just line the pockets of unscrupulous lawyers.

Two potential solutions may address the above, although these solutions ironically may conflict with each other. First, if an officer / representative of a project was required to certify in a separate filing that they have provided all material facts to outside counsel to produce the analysis, and further represent and certify that those facts are accurrate to their knowledge (after reasonable investigation into material facts), it would encourage projects/companies to priortize their own reporting and tracking obligations before submitting an exit report, because 10b5 liability could obtain. I don't want to scare too many from following this path with the above approach. However, I think on balance, requiring the leaders of a project to at least be willing to state publicly, under potential penalty of the law, that they have told the truth to the best of their knowledge to the lawyers who are about to help publicly bless a project that could impact hundreds of millions of public money after 3 years of nearly unfeterred development is reasonable.  

Second, the Commission could also consider requiring that outside counsel obtain a back up certificate from the Company, similar to the backup certificates that are common in venture capital transactions for legal opinions. This would at least provide some additional teeth to the report, although I posit that, without potential liability applying to the firm, this backup cert may have limited value. That said, I do not think imposing liability on the firm (except for intentional fraud or wilful misconduct) would make sense. It would arguably be more fair, but no law firm or lawyer of worth would risk their reputation and finances for a one off transaction if less stringent liability standards apply.

Finally, there's a real question in my mind as to whether the Exit Report should instead come from the Company and have a backup certification from the law firm rather than vice versa as proposed above. In this world, the report would be a public disclosure doc and the Company, rather than the firm, would be more responsible for material misttatements or omissions. That said, this would warrant more reflection. 

My sense is that the idea with requiring outside counsel to provide the analysis is that they will help to provide a gatekeeper function, as lawyers would not be willing to risk a public filing that isn't "bulletproof." However, in my experience, this is unlikely to obtain. The above proposals are some initial thoughts on how to keep this flexible framework but shift some responsibility back to companies to really ensure they are "truly decentralized" before being a digital public utility and tries to stymie the ability for projects or companies to hide behind lawyers.
